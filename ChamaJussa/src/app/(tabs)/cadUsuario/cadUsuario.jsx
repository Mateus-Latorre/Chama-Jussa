...
import { styles } from './StyleCadUsuario';
                    ...
                    <View style={styles.container}>
                        ...
                        <View style={styles.formulario}>
                            ...
                            <View style={styles.inputs}>
                                <Text style={styles.pedidoCaixa}>Nome de Usuario</Text>
                                <TextInput style={styles.input} placeholder='Ex: Eduardo'/>
                                ...
                                <TouchableOpacity style={styles.botao}>
                                    <Text style={styles.textobtn}>Cadastrar usuario</Text>
                                </TouchableOpacity>
